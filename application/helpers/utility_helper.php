...
if (! function_exists("validate_mobile_no")) {
	function validate_mobile_no($mobile_no, $country_code = "63", $limit = "12") {
		$limit = $limit - strlen($country_code);
    	return preg_match('/'.$country_code.'+[0-9]{'.$limit.'}/s', $mobile_no);
	}
}

if (! function_exists('qr_image_data')){
	function qr_image_data($date) {
